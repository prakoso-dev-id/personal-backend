            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/experiences.UpdateExperienceRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/images.ImageUploadResult"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/contact.ContactMessage"
                            }
                        }
                    },
                    "500": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/auth.UpdateEmailRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/contact.CreateMessageRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "profiles.Profile": {
            ...
            "properties": {
                ...
                "experiences": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/profiles.Experience"
                    }
                },
                "fullName": {
                    "type": "string"
                ...
                "socialLinks": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/profiles.SocialLink"
                    }
                },
                "updatedAt": {
                    "type": "string"
